// SK set timeout to 5000000 on line 698 (from 5000) to keep popup controls visible	
...
((function() {
	...
	c = function() {
		...
		return H(e, c), e.prototype.events = {
			...
			}, 5000000), this.element.removeClass(this.classes.hide), this.checkOrientation().publish("show")
