...
var readStyle = false; // added by SK
var readMargin = false;
var readSize = false;
...
var readability = {
	...
	//SK: instead of messing up the root document, create an element and add things there
    ...
    init: function(element, overlayName, parentName) {		
       ...
       //  overlay.appendChild( articleTools   );
		 ...
		 $('#readabilityClone').remove();



        /* Clear the old HTML, insert the new content. */
		// document.body.innerHTML = ""; // SK removed
        $(parentName).append(overlay);
		$(overlay).hide()
...
*/
    ...
    **/
    grabArticle: function (page) {
		...
		var clone = $(page).clone()[0]
		clone.id = "readabilityClone";
		document.body.appendChild(clone);
		//return;
		
		page = clone;
        var allElements = page.getElementsByTagName('*'); // changed from page to work on clone
