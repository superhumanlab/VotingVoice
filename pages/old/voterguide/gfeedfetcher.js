...
var gfeedfetcher_loading_image="/images/alts/indicator.gif" //Full URL to "loading" image. No need to config after this line!!
...
gfeedfetcher.prototype._displayresult=function(feeds){
	...
	for (var i=0; i<feeds.length; i++){
		var itemtitle="<a href=\"" + feeds[i].link + "\" target=\"" + this.linktarget + "\" class=\"titlefield\" style=\"font-weight:bold;\">" + feeds[i].title + "</a>"
		var itemlabel=/label/i.test(this.showoptions)? '<span class="labelfield">in <strong>'+this.feeds[i].ddlabel+'</strong></span>' : " "
